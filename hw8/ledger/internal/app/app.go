...
import (
	...
	"github.com/mikhailmogilnikov/go/hw8/ledger/internal/cache"
	"github.com/mikhailmogilnikov/go/hw8/ledger/internal/repository/pg"
	"github.com/mikhailmogilnikov/go/hw8/ledger/internal/service"
)

// buildDSNFromEnv строит DSN для подключения к БД из переменных окружения
...
func InitService(ctx context.Context) (service.Service, func() error, error) {
	...
	// Инициализация кэша (опционально, не критично если недоступен)
