...
type AddTransactionResponse struct {
	...
	BudgetExceeded bool                   `protobuf:"varint,2,opt,name=budget_exceeded,json=budgetExceeded,proto3" json:"budget_exceeded,omitempty"` // флаг превышения бюджета
	BudgetWarning  string                 `protobuf:"bytes,3,opt,name=budget_warning,json=budgetWarning,proto3" json:"budget_warning,omitempty"`     // предупреждение если близко к лимиту
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type GetTransactionsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	From          *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=from,proto3" json:"from,omitempty"`         // опционально
	To            *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=to,proto3" json:"to,omitempty"`             // опционально
	Category      string                 `protobuf:"bytes,4,opt,name=category,proto3" json:"category,omitempty"` // фильтр по категории
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Budget struct {
	...
	Period        string                 `protobuf:"bytes,5,opt,name=period,proto3" json:"period,omitempty"` // "monthly" или "weekly"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CategorySummary struct {
	...
	BudgetLimit      float64                `protobuf:"fixed64,3,opt,name=budget_limit,json=budgetLimit,proto3" json:"budget_limit,omitempty"`                // лимит бюджета (0 если не задан)
	BudgetPercentage float64                `protobuf:"fixed64,4,opt,name=budget_percentage,json=budgetPercentage,proto3" json:"budget_percentage,omitempty"` // процент использования бюджета
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
var file_ledger_proto_goTypes = []any{
	...
	(*AddTransactionRequest)(nil),   // 1: ledger.v1.AddTransactionRequest
	(*AddTransactionResponse)(nil),  // 2: ledger.v1.AddTransactionResponse
	...
	(*SetBudgetRequest)(nil),        // 6: ledger.v1.SetBudgetRequest
	(*SetBudgetResponse)(nil),       // 7: ledger.v1.SetBudgetResponse
	...
	(*GetReportRequest)(nil),        // 11: ledger.v1.GetReportRequest
	(*GetReportResponse)(nil),       // 12: ledger.v1.GetReportResponse
	(*ImportCSVRequest)(nil),        // 13: ledger.v1.ImportCSVRequest
	(*ImportCSVResponse)(nil),       // 14: ledger.v1.ImportCSVResponse
	(*ExportCSVRequest)(nil),        // 15: ledger.v1.ExportCSVRequest
	(*ExportCSVResponse)(nil),       // 16: ledger.v1.ExportCSVResponse
	(*timestamppb.Timestamp)(nil),   // 17: google.protobuf.Timestamp
}
var file_ledger_proto_depIdxs = []int32{
	17, // 0: ledger.v1.Transaction.date:type_name -> google.protobuf.Timestamp
	17, // 1: ledger.v1.Transaction.created_at:type_name -> google.protobuf.Timestamp
	17, // 2: ledger.v1.AddTransactionRequest.date:type_name -> google.protobuf.Timestamp
	0,  // 3: ledger.v1.AddTransactionResponse.transaction:type_name -> ledger.v1.Transaction
	17, // 4: ledger.v1.GetTransactionsRequest.from:type_name -> google.protobuf.Timestamp
	17, // 5: ledger.v1.GetTransactionsRequest.to:type_name -> google.protobuf.Timestamp
	0,  // 6: ledger.v1.GetTransactionsResponse.transactions:type_name -> ledger.v1.Transaction
	5,  // 7: ledger.v1.SetBudgetResponse.budget:type_name -> ledger.v1.Budget
	5,  // 8: ledger.v1.GetBudgetsResponse.budgets:type_name -> ledger.v1.Budget
	17, // 9: ledger.v1.GetReportRequest.from:type_name -> google.protobuf.Timestamp
	17, // 10: ledger.v1.GetReportRequest.to:type_name -> google.protobuf.Timestamp
	10, // 11: ledger.v1.GetReportResponse.categories:type_name -> ledger.v1.CategorySummary
	17, // 12: ledger.v1.GetReportResponse.from:type_name -> google.protobuf.Timestamp
	17, // 13: ledger.v1.GetReportResponse.to:type_name -> google.protobuf.Timestamp
	17, // 14: ledger.v1.ExportCSVRequest.from:type_name -> google.protobuf.Timestamp
	17, // 15: ledger.v1.ExportCSVRequest.to:type_name -> google.protobuf.Timestamp
	1,  // 16: ledger.v1.LedgerService.AddTransaction:input_type -> ledger.v1.AddTransactionRequest
	3,  // 17: ledger.v1.LedgerService.GetTransactions:input_type -> ledger.v1.GetTransactionsRequest
	6,  // 18: ledger.v1.LedgerService.SetBudget:input_type -> ledger.v1.SetBudgetRequest
	8,  // 19: ledger.v1.LedgerService.GetBudgets:input_type -> ledger.v1.GetBudgetsRequest
	11, // 20: ledger.v1.LedgerService.GetReport:input_type -> ledger.v1.GetReportRequest
	13, // 21: ledger.v1.LedgerService.ImportCSV:input_type -> ledger.v1.ImportCSVRequest
	15, // 22: ledger.v1.LedgerService.ExportCSV:input_type -> ledger.v1.ExportCSVRequest
	2,  // 23: ledger.v1.LedgerService.AddTransaction:output_type -> ledger.v1.AddTransactionResponse
	4,  // 24: ledger.v1.LedgerService.GetTransactions:output_type -> ledger.v1.GetTransactionsResponse
	7,  // 25: ledger.v1.LedgerService.SetBudget:output_type -> ledger.v1.SetBudgetResponse
	9,  // 26: ledger.v1.LedgerService.GetBudgets:output_type -> ledger.v1.GetBudgetsResponse
	12, // 27: ledger.v1.LedgerService.GetReport:output_type -> ledger.v1.GetReportResponse
	14, // 28: ledger.v1.LedgerService.ImportCSV:output_type -> ledger.v1.ImportCSVResponse
	16, // 29: ledger.v1.LedgerService.ExportCSV:output_type -> ledger.v1.ExportCSVResponse
